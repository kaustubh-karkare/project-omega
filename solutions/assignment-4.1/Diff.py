...
class diff():
    ...
    def __init__(self, commit_object):
        ...
        self.files_untracked = set()
        self.files_deleted: Dict[str, Union[tree,blob]] = dict()
        self.files_modified: Dict[str, Union[tree,blob]] = dict()
...
class Diff_file(object):
    def __init__(self,new_file,old_file):
        self.new_file_lines = []
        self.old_file_lines = []
        self.common_line_list = []
        self.insertions = 0;
        self.deletions = 0;
        self.modification_log = ''
        self._differ_file(new_file, old_file)
        self._difference_details()

    def _differ_file(self, new_file, old_file):
        try:
            ...
            print(e)
        self.common_line_list = self._lcs()
